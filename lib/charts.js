...
const ChartFunnel = require('https://cdn.jsdelivr.net/npm/chartjs-chart-funnel@1.0.4/dist/chart.funnel.js');
...
async function renderChartJs(
 ...
 if (!chart.options.plugins.datalabels) {
  ...
  display: ROUND_CHART_TYPES.has(chart.type),
  formatter: (val, ctx) => {
  ...
  if (version.startsWith('3') || version.startsWith('4')) {
    ...
    chart.plugins = [
      chartDataLabels,
      chartAnnotations,
      ChartFunnel,  // ADDED: Register funnel plugin for v2
    ];
